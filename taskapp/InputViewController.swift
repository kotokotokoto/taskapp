...
class InputViewController: UIViewController {
    ...
    @IBOutlet weak var cotegoryTextField: UITextField!
    ...
    override func viewDidLoad() {
        ...
        cotegoryTextField.text = task.category
    }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        try! realm.write {
            ...
            self.task.category = self.cotegoryTextField.text!
